...
# -*- coding: utf-8 -*-
#
# The STAK Project documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'TheSTAKProject.tex', 'The STAK Project Documentation',
...
man_pages = [
    (master_doc, 'thestakproject', 'The STAK Project Documentation',
     [author], 1)
]
